...
if (isset($_GET['keyword'])){
    $data_karyawan = readKaryawanFilter($_GET['keyword']);
}

if (isset($_GET['asc'])){
    $data_karyawan = readKaryawanFilter("");
}
        ...
        <div class="modal fade" id="EditModal<?= $d['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="tambahKaryawan" action="" method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" form="tambahKaryawan" name="sbmt-edit" class="btn btn-primary">Submit</button>
                    </div>
                </div>
            </div>
        </div>
